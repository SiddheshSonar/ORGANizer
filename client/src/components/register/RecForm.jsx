...
const RecForm = () => {
    ...
    return (
        <div className='w-full h-screen'>
            <form className='flex items-center justify-center flex-wrap gap-4 content-start w-full h-full' onSubmit={handleSubmit}>
                    <TextField
                        label="Name"
                        variant="outlined"
                    ...
                    <TextField
                        ...
                        onChange={(e) => setRegistrationDetails({ ...registrationDetails, confirmPassword: e.target.value })}
                    />
                    <TextField
                        label="Phone"
                        type='number'
                    ...
                    <TextField
                        ...
                        onChange={(e) => setRegistrationDetails({ ...registrationDetails, blood_group: e.target.value })}
                        variant="outlined"
                    >
                        {bGroup.map((option) => (
                    ...
                    <TextField
                        ...
                        onChange={(e) => setRegistrationDetails({ ...registrationDetails, age: e.target.value })}
                    />
                    ...
                    <TextField
                        ...
                        onChange={(e) => setRegistrationDetails({ ...registrationDetails, weight: e.target.value })}
                    />
                    <TextField
                        label="Height (cm)"
                        type='number'
                        ...
                        onChange={(e) => setRegistrationDetails({ ...registrationDetails, height: e.target.value })}
                    />
                        <TextField
